                    ...
                    <div class="relative">
                        ...
                        <ol class="ms-3 flex items-center whitespace-nowrap">
                            ...
                            <li class="text-sm font-semibold text-gray-800 truncate dark:text-neutral-400" aria-current="page">
                                <!-- Dashboard -->
                                <?php isset($_GET["route"]) == '' ? print(ucfirst("Dashboard")) : print(ucfirst($_GET["route"]));?>
                            </li>
                        </ol>
                        <!-- End Breadcrumb -->
                    </div>
...
<?php
                            ...
                            if (!empty($_SESSION['usuario_thumbnail'])) {
                                $imagen_src = $_SESSION['usuario_thumbnail'];
                            } else {
                                $imagen_src = "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80";
                            }
                            ?>
                            <img class="shrink-0 size-9.5 rounded-full" src="<?php echo $imagen_src; ?>" alt="Avatar">
                        </button>
