            ...
            <div class="grid gap-y-4">
              ...
              <div>
                <div class="flex flex-wrap justify-between items-center gap-2">
                  ...
                  <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-blue-500" href="../examples/html/recover-account.html">¿Olvidaste tu contraseña?</a>
                </div>
                <div class="relative">
              ...
              <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Iniciar Sesión</button>
            </div>
          </form>
          <!-- End Form -->
        </div>
